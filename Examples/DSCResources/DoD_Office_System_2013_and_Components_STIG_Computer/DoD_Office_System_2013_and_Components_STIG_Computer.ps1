Configuration 'DoD_Office_System_2013_and_Components_STIG_Computer'
{
    ...
    DoD_Office_System_2013_and_Components_STIG_Computer 'Example'
    {
    }
}
DoD_Office_System_2013_and_Components_STIG_Computer -OutputPath 'C:\DoD_Office_System_2013_and_Components_STIG_Computer'
